...
namespace MartianRobots.App
{
    class Program
    {
        ...
        private bool TryParseCoordinates(string input, out Point coordinates)
        {
            ...
            result &= int.TryParse(rawCoordinates[0], out parsedValue);
        ...
        private bool TryParseRobotPosition(string input, out Position position)
        {
